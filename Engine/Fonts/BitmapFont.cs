...
// Class for creating fonts from a bitmap file
...
namespace Engine
{
    public class BitmapFont : IEnumerable<Character>
    {
        ...
        public Size MeasureFont(string text, double maxWidth)
        {
            ...
            foreach (char character in normalizedText)
            {
                switch (character)
                {
                    case '\n':
                        ...
                        blockWidth = Maths.Max(blockWidth, currentLineWidth);
                        currentLineWidth = 0;
                        currentLineHeight = this.LineHeight;
                        break;
                    default:
                        ...
                        currentLineHeight = Maths.Max(currentLineHeight, data.Bounds.Height + data.Offset.Y);
            ...
            return new Size(Maths.Max(currentLineWidth, blockWidth), blockHeight);
        }
        ...
        {
            // this.texture = Texture.LoadFromFile(filepath);
        }
    }
}