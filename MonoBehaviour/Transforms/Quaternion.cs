...
namespace Engine
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        {
            float num = (float)Math.Sqrt(q.X * q.X + q.Y * q.Y + q.Z * q.Z);
            float num2 = (float)Math.Sin(num);
        ...
        public static Quaternion Slerp(Quaternion q1, Quaternion q2, float t)
        {
            ...
            if (num < 0.999f)
            {
                float num3 = (float)Math.Acos(num);
                float num4 = 1f / (float)Math.Sqrt(1f - num * num);
                num5 = (float)Math.Sin((1f - t) * num3) * num4;
                num6 = (float)Math.Sin(t * num3) * num4;
            }
            else
            {
                num5 = 1f - t;
        ...
        public Vector4 ToAxisAngle()
        {
            ...
            float num = 2f * (float)Math.Acos(quaternion.W);
            float num2 = (float)Math.Sqrt(1.0 - (double)(quaternion.W * quaternion.W));
            if (num2 > 0.0001f)
            {
