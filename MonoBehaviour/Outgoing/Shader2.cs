...
namespace Engine
{
    ...
    public class Shader2
    {
        ...
        public Shader2(string vertPath, string fragPath)
        {
            ...
            //    var key = GL.GetActiveUniform(Handle, i, out _, out _);
                ...
                // get the location,
             //   var location = glGetUniformLocation(Handle, key);
        ...
        private static void CompileShader(uint shader)
        {
            ...
            if (status[0] == 0)
            {
                Debug.WriteLine("ERROR COMPILING SHADER");
            }
        }
        ...
        ///   </para>
        /// </remarks>
        public void SetMatrix4(string name, System.Numerics.Matrix4x4 data)
        {
            glUseProgram(Handle);
