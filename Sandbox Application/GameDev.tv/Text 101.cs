...
public class Text101 : EngineMain
{
    ...
    public unsafe override void LoadContent()
    {
        ...
        _shader = new Shader(
            "F:\\GameDev\\Engine\\MonoBehaviour\\Rendering\\Shaders\\OpenTK.vert",
            "F:\\GameDev\\Engine\\MonoBehaviour\\Rendering\\Shaders\\OpenTK.frag");
        _shader.Use();
        ...
        _texture = Texture.LoadFromFile("F:\\GameDev\\Engine\\MonoBehaviour\\Graphics\\Fonts\\Example Font.png");
