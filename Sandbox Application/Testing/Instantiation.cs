...
public class Instantiation : EngineMain
{
    ...
    public unsafe override void LoadContent()
    {
        ...
        cube2.SetPosition(new Vector3(2.0f, 5.0f, -15.0f));
        cube3.SetPosition(new Vector3(-1.5f, -2.2f, -2.5f));
        cube4.SetPosition(new Vector3(-3.8f, -2.0f, -12.3f));
        cube5.SetPosition(new Vector3(2.4f, -0.4f, -3.5f));
        cube6.SetPosition(new Vector3(-1.7f, 3.0f, -7.5f));
        cube7.SetPosition(new Vector3(1.3f, -2.0f, -2.5f));
        cube8.SetPosition(new Vector3(1.5f, 2.0f, -2.5f));
        cube9.SetPosition(new Vector3(1.5f, 0.2f, -1.5f));
        cube10.SetPosition(new Vector3(-1.3f, 1.0f, -1.5f));
