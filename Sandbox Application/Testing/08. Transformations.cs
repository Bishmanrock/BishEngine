...
public class Transformations : EngineMain
{
    ...
    public unsafe override void LoadContent()
    {
        ...
        //F:\\GameDev\\MonoBehaviour\\Sandbox Application\\Texture\\awesomeface.png
        //F:\\GameDev\\MonoBehaviour\\Sandbox Application\\Texture\\Untitled.png
    ...
    public override void Update()
    {
        ...
        counter2 = counter2 + 1f * Time.deltaTime;
    }
    ...
    private void OpenTKApproach()
    {
        ...
        int location = glGetUniformLocation(_shader.Handle, "transform");

        glUniformMatrix4fv(location, 1, true, _vertices);
    }

    private void OpenGLApproach()
    {
        Matrix4x4 transform;

        transform = Matrix4x4.CreateScale(0.5f, -0.5f, 0.0f);
        transform = Matrix4x4.CreateRotationZ(0 + counter);

        _shader.Use();

        int transformLocation = glGetUniformLocation(_shader.Handle, "transform");

        glUniformMatrix4fv(transformLocation, 1, true, _shader.GetMatrix4x4Values(transform));
    }
}